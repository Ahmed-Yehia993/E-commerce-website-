...
$sql = "SELECT date_time, Shipping_company, shipped_flag  FROM `orderprocessing` WHERE Transaction_ID = '$ID' ";
...
if (!is_null($result))
{
	...
	{
		$Time = $row['date_time']; 
		$ShipCo = $row['Shipping_company'];
 		$Shipflg = $row['shipped_flag']; 

 		
 	if ($Shipflg === '1')
 	{
 		echo "  The Shipping Company is :  ".$ShipCo. "  And The time of shippment is :  ".$Time;
 	}
 	else if ($Shipflg === '0')
 	{
        echo "The order isn't Shipped yet! ";
 	}
