   ...
   <!------------End Header ------------>
	   ...
	   <form name = "myform" Action = "UpdateProduct.php" method = "POST" >
			...
			<button  name = "su"> update </button>
				<input   type="button" value="Add Item" onClick="window.location.href='InsertProduct.php'">
		</form>  
		...
		<?php 
			...
			while($strrow = mysqli_fetch_array($result)){ 
					/*echo $strrow['ItemName']. " ". $strrow['Item_Description'] . " ".
					$strrow['Quantity'] ." ".
					$strrow['Price'] ." ".
					$strrow['Category'] ." ".
					$strrow['Sub_Category'] ." ".
					...
					?>
					<tr>
					<td><?php echo $strrow['Product_ID'];?></td>
					<td><?php echo $strrow['ItemName'];?></td>
					<td><?php echo $strrow['Item_Description'];?></td>		
					<td><?php echo $strrow['Quantity'];?></td>
					<td><?php echo $strrow['Price'];?></td>
					<td><?php echo $strrow['Category'];?></td>		
					<td><?php echo $strrow['Sub_Category'];?></td>
					<td><?php echo $strrow['Visible'] ? "Visible" : "Not Visible"; ?> </td>
					</tr>
				<?php					
			}
			?>
